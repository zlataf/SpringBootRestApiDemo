...
public class FileInfoServiceRepository {
	 ...
	 * @return
	 */
	public List<Long> searchFileId(String fileName, String fileType, Timestamp dateCreatedBefore,
			Timestamp dateCreatedAfter, Boolean publicAccess, Long sizeLarger, Long sizeSmaller) {
